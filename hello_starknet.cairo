...
trait IERC721<TContractState> {
    ...
    fn get_image(self: @TContractState) -> felt252;
    fn get_banner_image_url(self: @TContractState) -> felt252;
...
mod ERC721 {
   ...
   #[constructor]
fn constructor(ref self: ContractState, _name: felt252, _symbol: felt252, tanim: felt252, _image: felt252 , _banner: felt252 , base_tokuri: felt252) {
    
    self.name.write(_name);
    self.symbol.write(_symbol);
    self.description.write(tanim);
    self.image.write(_image);
    self.banner_image_url.write(_banner);
    self.tokURI.write(base_tokuri);
}
    ...
    impl IERC721Impl of super::IERC721<ContractState> {
        ...
        fn get_image(self: @ContractState) -> felt252 {
            self.image.read()
        }
        fn get_banner_image_url(self: @ContractState) -> felt252 {
            self.banner_image_url.read()
        }
